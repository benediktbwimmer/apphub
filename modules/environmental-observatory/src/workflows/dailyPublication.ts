  ...
  steps: [
    {
      ...
      parameters: {
        ...
        instrumentId: '{{ parameters.instrumentId | default: null }}',
        lookbackMinutes: '{{ parameters.lookbackMinutes | default: 180 }}',
        siteFilter: '{{ parameters.siteFilter | default: null }}',
        filestoreBaseUrl: '{{ parameters.filestoreBaseUrl }}',
        filestoreBackendId: '{{ parameters.filestoreBackendId }}',
        filestoreToken: '{{ parameters.filestoreToken | default: null }}',
        filestorePrincipal: '{{ parameters.filestorePrincipal | default: null }}',
    ...
    },
    {
      ...
      parameters: {
        ...
        instrumentId: '{{ parameters.instrumentId | default: null }}',
        lookbackMinutes: '{{ parameters.lookbackMinutes | default: 180 }}',
        reportTemplate: '{{ parameters.reportTemplate | default: null }}',
