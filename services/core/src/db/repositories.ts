...
export type NukeCoreCounts = Record<string, number>;
...
async function truncateTables(tables: readonly string[]): Promise<NukeCoreCounts> {
  return useTransaction(async (client) => {
    const counts: NukeCoreCounts = {};
...
export async function nukeCoreRunData(): Promise<NukeCoreCounts> {
  return truncateTables(RUN_DATA_NUKE_TABLES);
}

export async function nukeCoreDatabase(): Promise<NukeCoreCounts> {
  return truncateTables(FULL_NUKE_TABLES);
}

export async function nukeCoreEverything(): Promise<NukeCoreCounts> {
  return useTransaction(async (client) => {
    const counts: NukeCoreCounts = {};
