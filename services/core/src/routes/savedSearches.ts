...
export async function registerSavedSearchRoutes(app: FastifyInstance): Promise<void> {
  app.get(
    '/saved-searches',
    {
      schema: {
        tags: ['Saved Searches'],
        summary: 'List saved core searches',
        description: 'Returns saved core searches owned by the authenticated operator.',
        security: [{ OperatorToken: [] }],
        querystring: savedSearchListQueryOpenApiSchema,
        response: {
          200: jsonResponse('SavedCoreSearchListResponse', 'Saved searches available to the caller.'),
    ...
    async (request, reply) => {
      const authResult = await requireOperatorScopes(request, reply, {
        action: 'core.saved-searches.list',
        resource: 'core/saved-searches',
        requiredScopes: []
      });
      if (!authResult.ok) {
  ...
  app.post(
    '/saved-searches',
    {
      schema: {
        tags: ['Saved Searches'],
        summary: 'Create a saved core search',
        description: 'Persists a reusable core search definition for the authenticated operator.',
        security: [{ OperatorToken: [] }],
        body: schemaRef('SavedCoreSearchCreateRequest'),
        response: {
          201: jsonResponse('SavedCoreSearchResponse', 'Saved search created successfully.'),
    ...
    async (request, reply) => {
      const authResult = await requireOperatorScopes(request, reply, {
        action: 'core.saved-searches.create',
        resource: 'core/saved-searches',
        requiredScopes: []
      });
      if (!authResult.ok) {
  ...
  app.get(
    ...
    async (request, reply) => {
      const authResult = await requireOperatorScopes(request, reply, {
        action: 'core.saved-searches.get',
        resource: 'core/saved-searches',
        requiredScopes: []
      });
    if (!authResult.ok) {
  ...
  app.patch(
    '/saved-searches/:slug',
    {
      schema: {
        tags: ['Saved Searches'],
        summary: 'Update a saved core search',
        description: 'Updates attributes of an existing saved search owned by the caller.',
        security: [{ OperatorToken: [] }],
        params: savedSearchSlugParamsOpenApiSchema,
        body: schemaRef('SavedCoreSearchUpdateRequest'),
        response: {
          200: jsonResponse('SavedCoreSearchResponse', 'Saved search updated.'),
    ...
    async (request, reply) => {
      const authResult = await requireOperatorScopes(request, reply, {
        action: 'core.saved-searches.update',
        resource: 'core/saved-searches',
        requiredScopes: []
      });
    if (!authResult.ok) {
  ...
  app.delete(
    '/saved-searches/:slug',
    {
      schema: {
        tags: ['Saved Searches'],
        summary: 'Delete a saved core search',
    ...
    async (request, reply) => {
      const authResult = await requireOperatorScopes(request, reply, {
        action: 'core.saved-searches.delete',
        resource: 'core/saved-searches',
        requiredScopes: []
      });
    if (!authResult.ok) {
  ...
  app.post(
    '/saved-searches/:slug/apply',
    {
      schema: {
        ...
        params: savedSearchSlugParamsOpenApiSchema,
        response: {
          200: jsonResponse('SavedCoreSearchResponse', 'Updated saved search metrics.'),
          400: errorResponse('The saved search slug was invalid.'),
          401: errorResponse('The caller is unauthenticated.'),
    ...
    async (request, reply) => {
      const authResult = await requireOperatorScopes(request, reply, {
        action: 'core.saved-searches.apply',
        resource: 'core/saved-searches',
        requiredScopes: []
      });
    if (!authResult.ok) {
  ...
  app.post(
    '/saved-searches/:slug/share',
    {
      schema: {
        ...
        params: savedSearchSlugParamsOpenApiSchema,
        response: {
          200: jsonResponse('SavedCoreSearchResponse', 'Updated saved search metadata.'),
          400: errorResponse('The saved search slug was invalid.'),
          401: errorResponse('The caller is unauthenticated.'),
          403: errorResponse('The caller is not authorized to update the saved search.'),
          404: errorResponse('The saved search does not exist.')
    ...
    async (request, reply) => {
      const authResult = await requireOperatorScopes(request, reply, {
        action: 'core.saved-searches.share',
        resource: 'core/saved-searches',
        requiredScopes: []
      });
    if (!authResult.ok) {
