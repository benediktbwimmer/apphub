...
async function run(): Promise<void> {
  ...
  process.env.CORE_METASTORE_BASE_URL = 'http://metastore.test';
  process.env.CORE_METASTORE_TOKEN = 'metastore-test-token';
  process.env.CORE_FILESTORE_BASE_URL = 'http://filestore.test';
  process.env.CORE_FILESTORE_TOKEN = 'filestore-test-token';
