...
function resolveVolumeMounts(_envVars?: LaunchEnvVar[]): ResolvedVolumeMount[] {
  return [];
}

export function resolveLaunchVolumeMounts(_envVars?: LaunchEnvVar[]): ResolvedVolumeMount[] {
  return [];
}
