...
const DEFAULT_WATCH_ROOT = path.resolve(ROOT_DIR, '../../catalog/data/examples/file-drop/inbox');
const DEFAULT_ARCHIVE_ROOT = path.resolve(ROOT_DIR, '../../catalog/data/examples/file-drop/archive');
