export const ROUTE_SEGMENTS = {
  ...
  servicesTimestoreStreaming: 'streaming',
...
export const ROUTE_PATHS = {
  ...
  servicesTimestoreStreaming: `/${ROUTE_SEGMENTS.services}/${ROUTE_SEGMENTS.servicesTimestore}/${ROUTE_SEGMENTS.servicesTimestoreStreaming}`,
