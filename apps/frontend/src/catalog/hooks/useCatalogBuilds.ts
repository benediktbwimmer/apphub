...
export type UseCatalogBuildsOptions = {
  repositories: Pick<CatalogRepositoryMutators, 'update'>;
};

export type UseCatalogBuildsResult = {
...
export function useCatalogBuilds(options: UseCatalogBuildsOptions): UseCatalogBuildsResult {
