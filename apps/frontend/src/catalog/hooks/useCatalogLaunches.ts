...
export type UseCatalogLaunchesOptions = {
  repositories: CatalogRepositoryMutators;
};

export type UseCatalogLaunchesResult = {
...
export function useCatalogLaunches(options: UseCatalogLaunchesOptions): UseCatalogLaunchesResult {
