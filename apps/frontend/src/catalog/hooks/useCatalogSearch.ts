...
export type CatalogRepositoryMutators = {
...
export type CatalogSearchHandlers = {
...
export type UseCatalogSearchResult = {
  inputValue: string;
...
export function useCatalogSearch(): UseCatalogSearchResult {
