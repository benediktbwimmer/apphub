...
import { closePool, resetDatabasePool } from '../../../services/core/src/db/client';
import {
  EVENT_QUEUE_NAME,
...
} from '../../../services/core/src/eventTriggerProcessor';
...
async function packageExampleBundles(slugs: readonly string[]): Promise<void> {
  const module = await import('../../../services/core/src/exampleBundleWorker');
...
async function runBenchmarkScenario(app: FastifyInstance, serverContext: ServerContext): Promise<void> {
  ...
  const envOverrides: Record<string, string> = {
    ...
    OBSERVATORY_CORE_BASE_URL: 'http://127.0.0.1:4000',
