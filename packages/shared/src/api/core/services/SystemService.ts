...
import type { def_98 } from '../models/def_98';
...
export class SystemService {
   ...
   * @returns def_96 The API is healthy and streaming (if enabled) is ready.
   * @throws ApiError
   */
  public getHealth(): CancelablePromise<def_96> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/health',
      errors: {
   ...
   * @returns def_98 Core services are ready to receive traffic.
   * @throws ApiError
   */
  public getReadyz(): CancelablePromise<def_98> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/readyz',
      errors: {
