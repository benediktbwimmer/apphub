...
export type ExampleJobSlug = 'file-relocator' | 'retail-sales-csv-loader' | 'retail-sales-parquet-builder' | 'retail-sales-visualizer' | 'fleet-telemetry-metrics' | 'greenhouse-alerts-runner' | 'observatory-inbox-normalizer' | 'observatory-duckdb-loader' | 'observatory-visualization-runner' | 'observatory-report-publisher' | 'scan-directory' | 'generate-visualizations' | 'archive-report';
...
export type ExampleWorkflowSlug = 'observatory-hourly-ingest' | 'observatory-daily-publication' | 'retail-sales-daily-ingest' | 'retail-sales-insights' | 'fleet-telemetry-daily-rollup' | 'fleet-telemetry-alerts' | 'directory-insights-report' | 'directory-insights-archive';
...
export declare function isScenarioType<T extends ExampleScenarioType>(scenario: ExampleScenario, type: T): scenario is Extract<ExampleScenario, {
    type: T;
}>;
export declare function groupScenariosByType(scenarios: ExampleScenario[]): {
